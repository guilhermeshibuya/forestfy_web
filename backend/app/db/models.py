...
class User(Base):
  ...
  id: Mapped[UUID] = mapped_column(UUID(as_uuid=True), default=uuid4, unique=True, nullable=False)
  ...
  classifications: Mapped[list["Classification"]] = relationship('Classification', back_populates='user')
...
class Classification(Base):
  ...
  species_classifications: Mapped[list['SpeciesClassification']] = relationship('SpeciesClassification', back_populates='classification')
...
class Species(Base):
  ...
  species_classifications: Mapped[list['SpeciesClassification']] = relationship('SpeciesClassification', back_populates='species')
  species_images: Mapped[list['SpeciesImage']] = relationship('SpeciesImage', back_populates='species')
...
class SpeciesClassification(Base):
  ...
  species: Mapped["Species"] = relationship('Species', back_populates='species_classifications')
  classification: Mapped["Classification"] = relationship('Classification', back_populates='species_classifications')
...
class SpeciesImage(Base):
  ...
  species: Mapped["Species"] = relationship('Species', back_populates='species_images')
